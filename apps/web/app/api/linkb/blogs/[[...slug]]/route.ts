...
export const createBlogsValidation = z.object({
    title: z.string().optional().nullable(), order: z.string().optional().nullable(), status: z.string().optional().nullable(), slug: z.string().optional().nullable(), content: z.string().optional().nullable(), image: z.string().optional().nullable(), date: z.string().optional().nullable(), custom: z.string().optional().nullable(), author: z.string().optional().nullable()
});

...
export const blogs = defaultSchema('blogs', {
...
export const blogsid = defaultSchema('blogs_id', {
  id: t.bigserial({ mode: 'number' }).primaryKey(),
  title: t.varchar(),
  order: t.integer(),
  status: t.text(),
...
export const authors = defaultSchema('authors', {
  id: t.bigserial({ mode: 'number' }).primaryKey(),
  name: t.varchar(),
});
...
export const settings2 = defaultSchema('settings2', {
  id: t.bigserial({ mode: 'number' }).primaryKey(),
  title: t.varchar(),
  navigation: t.varchar(),
  description: t.varchar(),

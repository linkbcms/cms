  ...
  return (
    <section id="pricing" className="px-8 py-20">
      <div className="mx-auto h-full max-w-5xl">
        ...
        <div className="mx-auto mt-12 flex flex-col items-start items-center gap-2 lg:grid lg:grid-cols-3">
          <div className="flex h-full flex-col justify-between rounded-3xl bg-gray-50 p-8">
            <div className="flex flex-col">
              <div>
                <h3 className="mt-4 font-medium text-gray-900">
                  SendIt Monthly License
                </h3>
              </div>
              ...
              <ul className="mt-12 flex flex-col gap-2 text-gray-600 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <p>Boost your productivity with SendIt</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0">
                    <svg
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>Permanent access to the SendIt community</p>
                </li>
              </ul>
            </div>
            <div className="mt-8">
              <button className="flex h-10 w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 font-semibold text-gray-600 text-sm transition-all">
                Get started
              </button>
            </div>
          </div>
          <div className="flex h-full flex-col justify-between rounded-3xl bg-[#cff245] p-8 text-black">
            <div className="flex flex-col">
              <div>
                <h3 className="mt-4 font-medium">SendIt Yearly License</h3>
              </div>
              <div className="order-first font-medium text-2xl">
                $80 <span>/year</span>
              </div>
              ...
              <ul className="mt-12 flex flex-col gap-2 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>Permanent access to theSendIt community</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0">
                    <svg
          ...
          <div className="flex h-full flex-col justify-between rounded-3xl bg-gray-50 p-8">
            <div className="flex flex-col">
              <div>
                <h3 className="mt-4 font-medium">SendIt Perpetual License</h3>
              </div>
              <div className="order-first font-medium text-2xl">
